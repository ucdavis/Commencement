...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% if (Model.ErrorType == ErrorController.ErrorType.UnauthorizedAccess) { %>
        ...
        <p>
            If you would like to petition to participate in the ceremony please complete <a href="<%= Url.Content("~/Forms/registration_petition.pdf") %>">this form</a> (If you are having trouble, right click on the link and choose "save as" to download the file) and submit it to commencement@caes.ucdavis.edu.
        </p>
