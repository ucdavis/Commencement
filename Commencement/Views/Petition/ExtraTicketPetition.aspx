...
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="MainContent">
    ...
    <ul class="extraTicketPetition_form">
    ...
    <ul class="extraTicketPetition_form">
        <li><strong>Address Line 1:</strong>
            <%= Html.TextBoxFor(x => x.ExtraTicketPetition.Address1)%>
            <%= Html.ValidationMessageFor(x => x.ExtraTicketPetition.Address1)%>
        </li>
        <li><strong>Address Line 2:</strong>
            <%= Html.TextBoxFor(x => x.ExtraTicketPetition.Address2)%>
            <%= Html.ValidationMessageFor(x => x.ExtraTicketPetition.Address2)%>
        </li>
        <li><strong>City:</strong>
            <%= Html.TextBoxFor(x => x.ExtraTicketPetition.City)%>
            <%= Html.ValidationMessageFor(x=>x.ExtraTicketPetition.City) %>
        </li>
        <li><strong>State:</strong>
            <%= this.Select("ExtraTicketPetition.State").Options(Model.States, x => x.Id, x => x.Name).Selected("CA")%>
        ...
        <li><strong>Zip Code:</strong>
            <%= Html.TextBoxFor(x => x.ExtraTicketPetition.Zip, new { maxlength = 5, size = 5 }) %>
            <%= Html.ValidationMessageFor(x=>x.ExtraTicketPetition.Zip) %>
        </li>
    ...
    <ul class="extraTicketPetition_form">
        <li><strong>Tickets Requested:</strong>
            <%= Html.TextBoxFor(x => x.ExtraTicketPetition.NumberTickets, new { maxlength = 2, size = 5 })%>
            <%= Html.ValidationMessageFor(x => x.ExtraTicketPetition.NumberTickets)%>
        </li>
        <li class="prefilled"><strong>AM or PM Ceremony:</strong> <span>AM</span> </li>
       
    </ul>
    
    <input type="submit" value="Extra Ticket Petition" />
