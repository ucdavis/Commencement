<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Commencement.MVC.Controllers.ViewModels.AdminRegisterForStudentViewModel>" %>
                    ...
                    <div class="ceremony ui-corner-all">
                        ...
                        <li>
                            ...
                            <select id="<%: string.Format("ceremonyParticipations[{0}]_Tickets", a.Index) %>" name="<%: string.Format("ceremonyParticipations[{0}].Tickets", a.Index) %>" >
                                <% for (int i = 0; i <= a.Ceremony.TicketsPerStudent; i++) { %>
