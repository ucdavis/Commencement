...
CREATE PROCEDURE [dbo].[usp_TotalRegisteredStudentsForTerm]
	@term varchar(6)
AS
...
select s.lastname, s.firstname, s.studentid, s.MI
	, case 
		...
		, majors.CollegeCode
	, r.address1, r.address2, r.city, r.[state], r.zip, s.email as PrimaryEmail, r.Phonetic, r.CellNumberForText
